  ...
  return (
    <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50 p-4">
      <div className="bg-[#2a0e4a] text-white rounded-lg w-full max-w-md p-6 relative max-h-[90vh] overflow-y-auto">
        ...
        <h2 className="text-2xl font-bold text-yellow-300 mb-4">Hubungi Kami via email</h2>

        <p className="mb-6 text-gray-300">Silakan lengkapi data di bawah ini untuk menghubungi kami melalui email.</p>
