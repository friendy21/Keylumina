...
export function Footer() {
  return (
    <footer className="bg-[#660099] text-white py-8 w-full">
      <div className="container mx-auto px-4 flex flex-col items-center">
        ...
        <div className="flex flex-col md:flex-row items-center md:items-center justify-between mb-6 w-full">
          ...
          <div className="hidden md:flex items-center gap-8">
            <a
              href="https://wa.me/6287886928285?text=Hey%20I'm%20interested%20in%20the%20course"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center hover:text-[#FBCF41] transition-colors cursor-pointer"
            >
              <img src="/Whatsapp.png" className="w-6 h-6 mr-2" alt="WhatsApp" />
              <span>WhatsApp</span>
            </a>
